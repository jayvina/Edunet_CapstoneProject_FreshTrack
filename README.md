...
Capture — photo of groceries or a receipt
Recognize — a CNN classifies items / OCR reads receipt text
Predict — shelf-life lookup per food category
Remind — use-it-soon list + daily/weekly alerts
Suggest — recipes built around expiring items
